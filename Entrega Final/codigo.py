...
#archivo_url = 'https://raw.githubusercontent.com/karen0c/Proyecto-Flujo-en-Redes/main/Sistemas%20test/14%20nodos.txt' #14 nodos
#archivo_url = 'https://raw.githubusercontent.com/karen0c/Proyecto-Flujo-en-Redes/main/Sistemas%20test/33%20nodos.txt' #33 nodos
archivo_url = 'https://raw.githubusercontent.com/karen0c/Proyecto-Flujo-en-Redes/main/Sistemas%20test/69%20nodos.txt' #69 nodos
#archivo_url = 'https://raw.githubusercontent.com/karen0c/Proyecto-Flujo-en-Redes/main/Sistemas%20test/84%20nodos.txt' #84 nodos
#archivo_url = 'https://raw.githubusercontent.com/karen0c/Proyecto-Flujo-en-Redes/main/Sistemas%20test/124%20nodos.txt' #119 nodos
#archivo_url = 'https://raw.githubusercontent.com/karen0c/Proyecto-Flujo-en-Redes/main/Sistemas%20test/136%20nodos.txt' #136 nodos
#archivo_url = 'https://raw.githubusercontent.com/karen0c/Proyecto-Flujo-en-Redes/main/Sistemas%20test/202%20nodos.txt' #202 nodos
...
def dijkstra_con_monticulo(grafo, inicio):
    ...
    distancias[inicio] = 0
    padres = {nodo: None for nodo in grafo}  # Para almacenar el nodo padre en el camino más corto
    visitados = set()
        ...
        for vecino, peso in grafo[nodo_actual].items():
            if vecino not in visitados:
                ...
                if nueva_distancia < distancias[vecino]:
                    ...
                    padres[vecino] = nodo_actual  # Actualizar el padre del vecino
...
def construir_grafo(resultados):
    distancias, padres = resultados
    grafo = nx.DiGraph()
    
    for nodo, padre in padres.items():
        if padre is not None:
            distancia = distancias[nodo]
            grafo.add_edge(padre, nodo, distancia=distancia)

    return grafo


grafo_desde_diccionario = convertir_diccionario_a_grafo(R)

# Ejemplo de uso con Dijkstra usando el nuevo grafo.
nodo_inicio = nref
resultados_dijkstra = dijkstra_con_monticulo(grafo_desde_diccionario, nodo_inicio)

distancias_resultado = resultados_dijkstra[0]
padres_resultado = resultados_dijkstra[1]
...
grafo_resultante = construir_grafo(resultados_dijkstra)

# Dibuja el grafo
pos = nx.spring_layout(grafo_resultante)
nx.draw(grafo_resultante, pos, with_labels=True, font_weight='bold', node_size=700, node_color='skyblue', font_color='black', font_size=8, edge_color='gray', width=0.5, arrowsize=10)
plt.show()
...
# Establecer el parámetro MIPFocus (o cualquier otro parámetro personalizado).
...
if model.status == gp.GRB.OPTIMAL:
    ...
    print("Valor de la función objetivo:", model.objVal*sbase)
